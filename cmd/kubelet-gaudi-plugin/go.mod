...
replace k8s.io/dynamic-resource-allocation v0.35.0 => github.com/ffromani/kubernetes/staging/src/k8s.io/dynamic-resource-allocation v0.0.0-20260224143250-504acd30aba6
